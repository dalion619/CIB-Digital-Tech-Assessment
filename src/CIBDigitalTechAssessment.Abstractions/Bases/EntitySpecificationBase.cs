...
{
    public abstract class EntitySpecificationBase<TEntity> : IEntitySpecification<TEntity>
    {
        protected EntitySpecificationBase(Expression<Func<TEntity, bool>> criteria)
        {
            Criteria = criteria;
        }
